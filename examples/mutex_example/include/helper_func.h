...
void RunTest(const std::string& name,
  ...
  std::cout << "Read: " << read_time_sum / read_loops_sum << "ns ("
            << read_loops_sum << " calls)" << std::endl;
  std::cout << "Write: " << write_time_sum / write_loops_sum << "ns ("
            << write_loops_sum << " calls)" << std::endl;
}
