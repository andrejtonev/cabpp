...
int main(int argc, char **argv) {
  ...
  RunTest(
      "MutexClass<int> 1 reader(0 nop) 1 writer...",
      [&mtx_i_0](int in) -> int {
        mtx_i_0.Write(in);
        return 0;
      },
  ...
  RunTest(
      "MutexClass<int> 1 reader(100 nop) 1 writer...",
  ...
  RunTest(
      "MutexClass<int> 1 reader(10000 nop) 1 writer...",
  ...
  RunTest(
      "CABpp<string> 3 readers 5 writers...",
      [&cab_str](int in) -> int {
  ...
  RunTest(
      "MutexClass<string> 3 readers(0 nop) 5 writers...",
  ...
  RunTest(
      "MutexClass<string> 3 readers(100 nop) 5 writers...",
  ...
  RunTest(
      "MutexClass<string> 3 readers(10000 nop) 5 writers...",
  ...
  RunTest(
      "CABpp<vector> 16 readers 3 writers...",
      [&cab_v](int in) -> int {
  ...
  RunTest(
      "MutexClass<vector> 16 readers(0 nop) 3 writers...",
      [&mtx_v_0](int in) -> int {
  ...
  RunTest(
      "MutexClass<vector> 16 readers(100 nop) 3 writers...",
  ...
  RunTest(
      "MutexClass<vector> 16 readers(10000 nop) 3 writers...",
